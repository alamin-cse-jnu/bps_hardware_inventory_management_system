...
urlpatterns = [
    ...
    path("view/components/",              views.view_components,           name="components_view"),
    ...
    path("excel/components/",          views.download_components,         name="components_excel"),
    ...
    path("pdf/components/",         views.download_components_pdf,         name="components_pdf"),
